...
export const EditorEnabler = () => (
  <>
    ...
    <div class={[styles.bubbleMenu, 'bubbleMenu']}>
      ...
      <div>
        <button type="button" class="bmButton" data-command="alignLeft">
          <LeftIcon />
        </button>
        <button type="button" class="bmButton" data-command="alignCenter">
          <CenterIcon />
        </button>
        <button type="button" class="bmButton" data-command="alignRight">
          <RightIcon />
        </button>
      </div>
    </div>
